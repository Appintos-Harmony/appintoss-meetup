...
- [개발 방식: AI 멀티에이전트 파이프라인](#개발-방식-ai-멀티에이전트-파이프라인)
- [품질·테스트](#품질테스트)
- [빠른 시작](#빠른-시작)
- [프로젝트 구조](#프로젝트-구조)
- [회고와 배운 점](#회고와-배운-점)
...
| 실행면 | Claude Code, Codex | 설계·구현·테스트. 한 작업에서 같은 파일을 동시에 수정하지 않음 |
| 승인면 | 사람 | 범위·병합·배포의 최종 책임. AI는 승인자가 아님 |
...
- **AI가 만든 코드도 다른 눈으로 검증해야 한다.** AI 결과를 그대로 신뢰하지 않고 다른 계열 AI의 독립 검토와 exit 코드로 강제했더니, 보안 우회와 문서·코드 불일치를 사람이 손대기 전에 잡아냈다.
